          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {[
              ...
              <div key={i} className="relative h-48 w-full group [perspective:1000px]">
                <div 
                  className={`w-full h-full transition-transform duration-[800ms] ease-[cubic-bezier(0.23,1,0.32,1)] [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] group-hover:z-10`}
                >
